...
const fr = {
  ...
  admin: {
    ...
    sections: {
      ...
      settings: {
        ...
        notificationsDesc: "WhatsApp, Email et Telegram - Notifications de commandes",
        integrations: "Intégrations",
        integrationsDesc: "Connexion des services externes et API",
        database: "Base de données",
        databaseDesc: "Gestion des données et migrations",
        security: "Sécurité",
        securityDesc: "Paramètres de sécurité et d'accès",
        orderNotifications: "Notifications de commandes",
        whatsapp: "WhatsApp (Green-API)",
        whatsappDesc: "Notifications via WhatsApp Business API Green-API",
        phone: "Numéro de téléphone",
        idInstance: "ID Instance",
        apiTokenInstance: "Token API Instance",
        telegram: "Telegram",
        telegramDesc: "Notifications via Telegram Bot",
        botToken: "Token du bot",
        chatId: "ID du chat",
        email: "Email",
        emailDesc: "Notifications par email",
        smtpHost: "Hôte SMTP",
        smtpPort: "Port SMTP",
        ...
        test: "TEST",
        testSuccess: "Test réussi! Configuration valide.",
        testError: "Erreur de test. Vérifiez les paramètres.",
        systemCheck: "Vérification du système",
        systemCheckDesc: "État complet de la base de données et du stockage",
        sendSystemReport: "Envoyer le rapport",
        systemReportSent: "Rapport envoyé avec succès!",
        tables: "Tables",
  ...
  stock: {
    warehouseTerminal: "Terminal de Stock",
    warehouseSubtitle: "Gestion des mouvements de stock par scan de codes-barres",
    reception: "Réception",
    cashSale: "Vente Comptoir",
    quantity: "Quantité",
    currentStock: "Stock actuel",
    willBe: "Sera",
    price: "Prix",
    addStock: "Ajouter au stock",
    sellCash: "Vente au comptoir",
    scanTitle: "Scanner le code-barres",
    scanSubtitle: "Pointer la caméra sur le code-barres du produit",
    positionCode: "Positionnez le code dans le cadre",
    scanHint: "Utilisez la lampe de poche si nécessaire pour un meilleur éclairage",
    scan_success: "Produit identifié avec succès",
    scanAgain: "Scanner à nouveau",
    scanProduct: "Scanner un produit",
    productNotFound: "Produit non trouvé avec ce code-barres",
    scanError: "Erreur lors du scan",
    retry: "Réessayer",
    receptionSuccess: "Stock ajouté avec succès",
    cashSaleSuccess: "Vente comptoir enregistrée",
    operationError: "Erreur lors de l'opération",
    adminRequired: "Accès administrateur requis pour les ventes au comptoir",
    help: "Aide",
    helpScan: "Scannez le code-barres du produit pour le sélectionner",
    helpReception: "En mode Réception, entrez la quantité reçue et validez",
    helpCash: "Pour les ventes au comptoir, scannez et validez la vente",
...
const en = {
  ...
  admin: {
    ...
    sections: {
      ...
      settings: {
        ...
        notifications: "Notifications",
        notificationsDesc: "WhatsApp, Email and Telegram - Order notifications",
        integrations: "Integrations",
        integrationsDesc: "External services and API connections",
        database: "Database",
        databaseDesc: "Data management and migrations",
        security: "Security",
        securityDesc: "Security and access settings",
        orderNotifications: "Order notifications",
        whatsapp: "WhatsApp (Green-API)",
        whatsappDesc: "Notifications via WhatsApp Business API Green-API",
        phone: "Phone number",
        idInstance: "ID Instance",
        apiTokenInstance: "API Token Instance",
        telegram: "Telegram",
        telegramDesc: "Notifications via Telegram Bot",
        botToken: "Bot Token",
        chatId: "Chat ID",
        ...
        test: "TEST",
        testSuccess: "Test successful! Configuration is valid.",
        testError: "Test error. Check your parameters.",
        systemCheck: "System Check",
        systemCheckDesc: "Complete database and storage status",
        sendSystemReport: "Send Report",
        systemReportSent: "Report sent successfully!",
        tables: "Tables",
        records: "Records",
        dbSize: "DB Size",
  ...
  stock: {
    ...
    warehouseSubtitle: "Stock movements management via barcode scanning",
    reception: "Reception",
    cashSale: "Cash Sale",
    quantity: "Quantity",
    ...
    scanSubtitle: "Point camera at product barcode",
    positionCode: "Position code in frame",
    scanHint: "Use flashlight if needed for better lighting",
    scan_success: "Product identified successfully",
    scanAgain: "Scan again",
    scanProduct: "Scan product",
    productNotFound: "Product not found with this barcode",
    scanError: "Error during scan",
    retry: "Retry",
    receptionSuccess: "Stock added successfully",
    cashSaleSuccess: "Cash sale recorded",
    operationError: "Error during operation",
    adminRequired: "Admin access required for cash sales",
    help: "Help",
    helpScan: "Scan the product barcode to select it",
    helpReception: "In Reception mode, enter quantity received and confirm",
    helpCash: "For cash sales, scan and confirm the sale",
...
const ru = {
  ...
  admin: {
    ...
    sections: {
      ...
      settings: {
        ...
        notificationsDesc: "WhatsApp, Email и Telegram - Уведомления о заказах",
        integrations: "Интеграции",
        integrationsDesc: "Подключение внешних сервисов и API",
        database: "База данных",
        databaseDesc: "Управление данными и миграции",
        security: "Безопасность",
        securityDesc: "Настройки безопасности и доступа",
        orderNotifications: "Уведомления о заказах",
        whatsapp: "WhatsApp (Green-API)",
        whatsappDesc: "Уведомления через WhatsApp Business API Green-API",
        phone: "Номер телефона",
        idInstance: "ID Instance",
        apiTokenInstance: "API Token Instance",
        telegram: "Telegram",
        telegramDesc: "Уведомления через Telegram Bot",
        botToken: "Bot Token",
        chatId: "Chat ID",
        email: "Email",
        emailDesc: "Уведомления на почту",
        smtpHost: "SMTP Host",
        smtpPort: "SMTP Port",
        ...
        comingSoon: "Скоро",
        test: "ТЕСТ",
        testSuccess: "Тест успешен! Конфигурация верна.",
        testError: "Ошибка теста. Проверьте параметры.",
        systemCheck: "Состояние системы",
        systemCheckDesc: "Полный статус базы данных и хранилища",
        sendSystemReport: "Отправить отчёт",
        systemReportSent: "Отчёт успешно отправлен!",
        tables: "Таблиц",
        records: "Записей",
        dbSize: "Размер БД",
  ...
  stock: {
    warehouseTerminal: "Складской терминал",
    warehouseSubtitle: "Управление складскими операциями через сканирование штрихкодов",
    reception: "Приёмка",
    cashSale: "Продажа за наличные",
    quantity: "Количество",
    currentStock: "Текущий остаток",
    willBe: "Будет",
    price: "Цена",
    addStock: "Добавить на склад",
    sellCash: "Продать за наличные",
    scanTitle: "Сканировать штрихкод",
    scanSubtitle: "Наведите камеру на штрихкод товара",
    positionCode: "Расположите код в рамке",
    scanHint: "При необходимости используйте фонарик для лучшего освещения",
    scan_success: "Товар успешно найден",
    scanAgain: "Сканировать снова",
    scanProduct: "Сканировать товар",
    productNotFound: "Товар с таким штрихкодом не найден",
    scanError: "Ошибка при сканировании",
    retry: "Повторить",
    receptionSuccess: "Товар успешно добавлен на склад",
    cashSaleSuccess: "Продажа за наличные зарегистрирована",
    operationError: "Ошибка при выполнении операции",
    adminRequired: "Доступ только для администратора",
    help: "Помощь",
    helpScan: "Отсканируйте штрихкод товара для его выбора",
    helpReception: "В режиме Приёмка введите количество и подтвердите",
    helpCash: "Для продаж за наличные - отсканируйте и подтвердите",
